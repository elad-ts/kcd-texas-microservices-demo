...
JSON_PAYLOAD='{
    "messages": [
        ...
        {
            "role": "user",
            "content": "Analyze why a 100ms artificial delay in microservices-demo/frontend results in 1.1-1.8s UI latency. Be short and prcicese how we got the total delay ?.\n\n'"$ESCAPED_DATA"'"
        }
    ],
